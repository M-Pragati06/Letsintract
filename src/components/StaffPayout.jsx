...
const StaffPayout = ({ history, setHistory }) => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: "John Doe", mobile: "123-456-7890", incentive: '300', userCount: "23", email: "john@example.com" },
    { id: 2, name: "Jane Smith", mobile: "987-654-3210", incentive: '900', userCount: "56", email: "jane@example.com" },
    { id: 3, name: "David Johnson", mobile: "555-123-4567", incentive: '350', userCount: "45", email: "david@example.com" },
    { id: 4, name: "Emily Brown", mobile: "777-888-9999", incentive: '200', userCount: "30", email: "emily@example.com" },
  ]);
          ...
          <div className="p-5 mt-10">
            <div className="bg-white p-6 rounded-lg w-[500px] max-h-[80vh] flex flex-col" style={{ fontSize: "16px", boxShadow: "rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset" }}>
              ...
              <div className="flex-shrink-0">
                ...
                <p className="mb-2 flex justify-between mx-1">
                  <strong>Total Incentive:</strong> {selectedUser ?.userCount * selectedUser ?.incentive}
                </p>
              </div>
